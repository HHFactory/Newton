...
-- -----------------------------------------------------
-- Table `newton2`.`m_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `newton2`.`m_category` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `status` CHAR(8) NOT NULL DEFAULT 'valid' COMMENT '',
  `category_div` INT NOT NULL COMMENT '',
  `parent_category_id` INT UNSIGNED NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `newton2`.`m_faq` (
  ...
  `m_category_id` INT UNSIGNED NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_m_faq_m_category1_idx` (`m_category_id` ASC)  COMMENT '',
  CONSTRAINT `fk_m_faq_m_category1`
    FOREIGN KEY (`m_category_id`)
    REFERENCES `newton2`.`m_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 11
...
CREATE TABLE IF NOT EXISTS `newton2`.`m_manual` (
  ...
  `m_category_id` INT UNSIGNED NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_m_manual_m_category1_idx` (`m_category_id` ASC)  COMMENT '',
  CONSTRAINT `fk_m_manual_m_category1`
    FOREIGN KEY (`m_category_id`)
    REFERENCES `newton2`.`m_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
