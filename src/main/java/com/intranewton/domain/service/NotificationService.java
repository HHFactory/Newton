...
public class NotificationService {
	 ...
	 */
	public void createNotification(NotificationDAO notificationDAO){
	 ...
	 * @return notification
	 */
	public Notification convertDAOtoEntity(NotificationDAO notificationDAO){		
	...
	public List<NotificationDTO> getDTObyUserName(String userName){
		...
		for(Notification notification:notifications){			
			...
			notificationDTO.setUnreadMemberList(createUnReadUserList(notification.getNotificationTargetRoles(),userName));
